...
public class Main {
    ...
    public static void main(String[] args) {
        System.out.println(DodatkOpracujZdanie.medianaCiaguDlugosciWyrazow("ala,DÓĘRć mąka kota łódź. Ala Ma Trzy Koty, a te koty to nie moje-Masakracja kota kota"));

        Long dominanta = DodatkDominantZListyList.dajDominantZLong(List.of(List.of(11L, 16L, 13L), List.of(1324L, 9L, 13L), List.of(13L, 13L, 12L, 12L), List.of(13L, 590L, 12L, 9L)  ));
    ...
    private static Double sredniaDlSlowaZtychList(List<List<String>> listaListString){
